...
/**
 * @brief Namespace with functions relating to metainfo file and Torrent struct
 * 
 */
namespace torr {
  ...
  int parse_torrent(Torrent &torrent, std::string &torrent_str, const char* filename);
