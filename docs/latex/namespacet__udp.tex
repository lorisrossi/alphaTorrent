...
\item[\hyperlink{bug__bug000006}{Bug}]Actually a hardcoded key and port is used. \end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000005}{Bug}]In reality no checking is done, to be fixed soon\end{DoxyRefDesc}
