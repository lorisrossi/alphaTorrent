...
\item[\hyperlink{bug__bug000004}{Bug}]Actually a hardcoded key and port is used. \end{DoxyRefDesc}
\begin{DoxyRefDesc}{Todo}
\item[\hyperlink{todo__todo000006}{Todo}]Read port from config file and generate a key (insted of using the hardcoded one)\end{DoxyRefDesc}
...
\begin{DoxyRefDesc}{Bug}
\item[\hyperlink{bug__bug000003}{Bug}]In reality no checking is done, to be fixed soon\end{DoxyRefDesc}
